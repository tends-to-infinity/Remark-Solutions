...
//public class CouponRecyclerAdapter extends RecyclerView.Adapter<com.example.remarksolutions.MainArea.RedeemFragment.CouponRecyclerAdapter.CouponRecyclerViewHolder> {
//
...
//    @NonNull
//    @Override
//    public com.example.remarksolutions.MainArea.RedeemFragment.CouponRecyclerAdapter.CouponRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.childrv_redeem_layout,parent,false);
//
//        return new com.example.remarksolutions.MainArea.RedeemFragment.CouponRecyclerAdapter.CouponRecyclerViewHolder(view);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull com.example.remarksolutions.MainArea.RedeemFragment.CouponRecyclerAdapter.CouponRecyclerViewHolder holder, final int position) {
//
...
//        RelativeLayout relativeLayout=coupRedeem.findViewById(R.id.rlCoinLayout);
...
//                        int nCoins=cCOins;
//                        if (cCOins>=(Integer.parseInt(mCoins.getText().toString())/10.0))
//                        {
//                            nCoins=cCOins-(Integer.parseInt(mCoins.getText().toString())/10);
...
//                        else
//                        {
//                            throw new FirebaseFirestoreException("Coin Too Low",
...
public class CouponAdapter extends RecyclerView.Adapter<CouponAdapter.CouponViewHolder>{
    ...
    public CouponAdapter(ArrayList<CouponModel> couponModelArrayList) {
        this.couponModelArrayList = couponModelArrayList;
    }
